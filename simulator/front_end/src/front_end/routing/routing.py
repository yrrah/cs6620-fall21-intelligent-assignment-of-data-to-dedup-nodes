...
def get_routing(function_name: str, q_learning: str or None, epsilon: float or None, q_penalty: bool or None,
                domains_per_pod: int, num_pods: int) -> Tuple[Callable[[Region, int], int],
    ...
    @param q_penalty: add load and dispersion factors to reward function
